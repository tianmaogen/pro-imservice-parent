 ...
 */
@Data
public class IMMsgBatch implements Msg3times{
    //消息接收方账号
    ...
    public static IMMsgBatch getIMMsgBatch(String[] to_Account, Object data) {
        return getIMMsgBatch(to_Account, data, null, null);
    }

    public static IMMsgBatch getIMMsgBatch(String[] to_Account, Object data, String desc, String ext) {
        IMMsgBatch iMMsg = new IMMsgBatch();
    ...
    public static void main(String[] args) {
        IMMsgBatch iMMsg = new IMMsgBatch();
        iMMsg.setTo_Account(new String[] {"11"});
